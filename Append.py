...
class Ui_NewData(object):

    def setupUi(self, NewData):
        ...
        # self.Cancel.setGeometry(QtCore.QRect(200, 520, 121, 31))
        ...
        self.Submit.setGeometry(QtCore.QRect(300, 520, 121, 31))
    ...
    def appnd(self):
        ...
        x4 = self.lineEdit_4.text()
        x5 = self.lineEdit_5.text()
        x6 = self.lineEdit_6.text()
        x7 = self.lineEdit_7.text()
        x8 = self.lineEdit_8.text()
        x9 = self.lineEdit_9.text()
        x10 = self.lineEdit_10.text()
        x11 = self.lineEdit_11.text()
        x12 = self.lineEdit_12.text()
        x13 = self.lineEdit_13.text()
        x14 = self.lineEdit_14.text()
        x15 = self.lineEdit_15.text()
        x16 = self.lineEdit_16.text()
        x17 = self.lineEdit_17.text()
        x18 = self.lineEdit_18.text()
        x19 = self.lineEdit_19.text()
        conn = sqlite3.connect('steel_sections.sqlite')
        c = conn.cursor()
        params = (x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19)
        c.execute("INSERT INTO Beams VALUES(NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", params)
        conn.commit()
        ctypes.windll.user32.MessageBoxW(0, "Data Added", "Entry", 1)


    def retranslateUi(self, NewData):
        _translate = QtCore.QCoreApplication.translate
        NewData.setWindowTitle(_translate("NewData", "New Data"))
        self.Submit.setText(_translate("NewData", "Submit"))
        # self.Cancel.setText(_translate("NewData", "Cancel"))
